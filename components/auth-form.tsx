...
export default function AuthForm({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-10 sm:py-12 bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <Link href="/" className="flex items-center justify-center gap-2.5 mb-8 sm:mb-10">
        ...
        <Card className="bg-white dark:bg-slate-900 border-slate-200/60 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50 rounded-2xl overflow-hidden">
          <CardHeader className="border-b border-slate-200/60 dark:border-slate-800 bg-gradient-to-r from-slate-50 to-slate-100/50 dark:from-slate-900 dark:to-slate-800/50 pb-6">
            <CardTitle className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300 bg-clip-text text-transparent">{title}</CardTitle>
          ...
          <CardContent className="pt-6 sm:pt-8">
              ...
              <>
                <div className="relative my-5 sm:my-6">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white dark:bg-slate-900 px-3 text-slate-500 dark:text-slate-500 font-medium">Or continue with</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    className="w-full text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl font-medium"
                  >
                    <GoogleIcon />
                    Google
                  </Button>
            ...
            <div className="mt-5 sm:mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
              {bottomLink.text}{" "}
              <Link href={bottomLink.href} className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-semibold">
                {bottomLink.label}
              </Link>
            </div>
            {title === "Login" && (
              <div className="mt-4 text-center text-sm">
                <Link href="/auth/forgot-password" className="text-slate-500 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Forgot password?
                </Link>
              </div>
            )}
